...
const [collapse, setCollapse] = useState(true)
    ...
    return(
        <div className={`bg-primary-purple_light h-[100vh] pt-[3rem]  ${collapse ? 'max-w-[250px]':'w-[80px]'} duration-500 absolute top-0 ${openMenu ? 'left-0 ':'left-[-500px] duration-500'} z-50 md:static md:block`}>
